...
class Services(models.Model):
    parent_id = models.ForeignKey(to='self', on_delete=models.DO_NOTHING, null=True, default=None)
...
class SchedulerServices(models.Model):
    scheduler_id = models.ForeignKey(to=Scheduler, on_delete=models.DO_NOTHING, related_name='services')
    service_id = models.ForeignKey(to=Services, on_delete=models.DO_NOTHING)
